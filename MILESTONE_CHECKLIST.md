...
- [ ] РЎРѕР·РґР°С‚СЊ `MaacoDbContext`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<Project>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<TaskItem>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<Workflow>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<WorkflowStep>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<AgentDefinition>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<ToolExecution>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<LogEvent>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<Artifact>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<GitOperation>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<BuildRun>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<MemoryRecord>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<ApprovalRequest>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<LlmCallLog>`
- [ ] Р”РѕР±Р°РІРёС‚СЊ `DbSet<ProjectContextSnapshot>`

## Mappings

- [ ] РќР°СЃС‚СЂРѕРёС‚СЊ primary keys
- [ ] РќР°СЃС‚СЂРѕРёС‚СЊ foreign keys
- [ ] РќР°СЃС‚СЂРѕРёС‚СЊ enum conversion РІ string РёР»Рё int
- [ ] РќР°СЃС‚СЂРѕРёС‚СЊ `MetadataJson`
- [ ] РќР°СЃС‚СЂРѕРёС‚СЊ `Version` РєР°Рє concurrency token
- [ ] РќР°СЃС‚СЂРѕРёС‚СЊ cascade rules

## Indexes

- [ ] РРЅРґРµРєСЃ `Projects.RepositoryPath`
- [ ] РРЅРґРµРєСЃ `TaskItems.ProjectId`
- [ ] РРЅРґРµРєСЃ `Workflows.TaskId`
- [ ] РРЅРґРµРєСЃ `WorkflowSteps.WorkflowId`
- [ ] РРЅРґРµРєСЃ `ToolExecutions.WorkflowId`
- [ ] РРЅРґРµРєСЃ `LogEvents.WorkflowId`
- [ ] РРЅРґРµРєСЃ `Artifacts.TaskId`
- [ ] РРЅРґРµРєСЃ `GitOperations.TaskId`
- [ ] РРЅРґРµРєСЃ `BuildRuns.WorkflowId`
- [ ] РРЅРґРµРєСЃ `MemoryRecords.ProjectId`
- [ ] РРЅРґРµРєСЃ `ApprovalRequests.Status`

## Repositories

- [ ] РЎРѕР·РґР°С‚СЊ `IProjectRepository`
- [ ] РЎРѕР·РґР°С‚СЊ `ITaskRepository`
- [ ] РЎРѕР·РґР°С‚СЊ `IWorkflowRepository`
- [ ] РЎРѕР·РґР°С‚СЊ `ILogRepository`
- [ ] РЎРѕР·РґР°С‚СЊ `IMemoryRepository`
- [ ] Р РµР°Р»РёР·РѕРІР°С‚СЊ EF repositories
